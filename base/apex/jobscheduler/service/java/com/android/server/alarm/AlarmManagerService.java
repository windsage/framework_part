...
//T-HUB Core[SPD]: add by na.liu 20230421 start
...
//T-HUB Core[SPD]: add by na.liu 20230421 end
/**
    ...
    void deliverAlarmsLocked(ArrayList<Alarm> triggerList, long nowELAPSED) {
        ...
        for (int i = 0; i < triggerList.size(); i++) {
            ...
            try {
                ...
                ITranAlarmManagerService.Instance().hookAlarmStart(alarm.type, alarm.uid, alarm.packageName, alarm.statsTag);
