...
//SPD: add for hstd by yunjun.yang 20240912 start
import com.transsion.hubcore.healthstandard.ITranHealthStandard;
//SPD: add for hstd by yunjun.yang 20240912 end
...
final class DeletePackageHelper {
    ...
    public int deletePackageX(String packageName, long versionCode, int userId, int deleteFlags,
        ...
        if (res) {
            ...
            //SPD: add for hstd by yunjun.yang 20240912 start
            ITranHealthStandard.Instance().onPkgUninstall(packageName, deleteFlags);
            //SPD: add for hstd by yunjun.yang 20240912 end
