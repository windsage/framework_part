...
class BLASTSyncEngine {
    ...
    class SyncGroup {
        ...
        private void finishNow() {
            ...
            if( mWm.mAtmService.mRootWindowContainer != null
                    && mWm.mAtmService.mRootWindowContainer.getTopMostTask() != null) {
                String packageName = mWm.mAtmService.mRootWindowContainer.getTopMostTask().getBasePackageName();
                if (!(("com.transsion.hilauncher".equals(packageName)) || ("com.transsion.XOSLauncher".equals(packageName)))){
                    Trace.asyncTraceEnd(64, "Transsion-start " + packageName , -1);
                }
            }
