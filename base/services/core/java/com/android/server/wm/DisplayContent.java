...
class DisplayContent extends RootDisplayArea implements WindowManagerPolicy.DisplayContentInfo {
    ...
    private void updateBaseDisplayMetricsIfNeeded(DisplayInfo newDisplayInfo) {
        ...
        if (displayMetricsChanged || physicalDisplayChanged) {
            if (physicalDisplayChanged) {
                //T-HUB Core[SPD]:added for hook onDisplayChanged by song.tang 2024032 start
                ITranBoostScene.Instance().hookOnDisplayChangedStart();
                //T-HUB Core[SPD]:added for hook onDisplayChanged by song.tang 2024032 end
            ...
            if (physicalDisplayChanged) {
                ...
                //T-HUB Core[SPD]:added for hook onDisplayChanged by song.tang 2024032 start
                ITranBoostScene.Instance().hookOnDisplayChangedEnd();
                //T-HUB Core[SPD]:added for hook onDisplayChanged by song.tang 2024032 end
            }
        }
    }
    ...
    boolean updateFocusedWindowLocked(int mode, boolean updateInputWindows,
        ...
        //SDD: add for aegean by yunjun.yang 20250207 start
        ITranDisplayContent.Instance().updateFocusedWindowLocked(mCurrentFocus, newFocus);
        //SDD: add for aegean by yunjun.yang 20250207 end
