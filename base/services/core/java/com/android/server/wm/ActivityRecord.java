...
public final class ActivityRecord extends WindowToken {
    ...
    @NonNull
    public final ActivityInfo info; // activity info provided by developer in AndroidManifest
...
// QTI_END: 2022-10-06: Core: Merge changes from topic "am-000f4089-22e1-4b8b-a1ba-7df6718ad762" into t-keystone-qcom-dev
    ...
    boolean scheduleTopResumedActivityChanged(boolean onTop) {
        ...
        ProtoLog.v(WM_DEBUG_STATES, "Sending position change to %s, onTop: %b",
                this, onTop);
        //SDD: add for TranPM TOS1501-25596 by randong.nie 20241112 start
        ITranActivityRecord.Instance().hookTopActivityStateChanged(info, app.getProcessWrapper(), onTop);
        //SDD: add for TranPM TOS1501-25596 by randong.nie 20241112 end
