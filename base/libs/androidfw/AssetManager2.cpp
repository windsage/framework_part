...
void AssetManager2::BuildDynamicRefTable(ApkAssetsList apk_assets) {
  ...
  // set 0x09, because thub-res is 0x05, transsion-res is 0x06, icon-res is 0x07, meditake-res is 0x08,so need 3-rd overlay app package id self-increasing for 0x09
  // int next_package_id = 0x02;
  int next_package_id = 0x09;
