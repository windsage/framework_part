...
public final class SurfaceControl implements Parcelable {
    ...
    private static native int nativeGetSurfaceFlingerTid();
    private static native int nativeGetRenderEnginTid();
    private static native int[] nativeGetHwcTids();
     ...
     * @hide
     */
    public static int getSurfaceFlingerTid() {
        return nativeGetSurfaceFlingerTid();
    }

    /**
     * @hide
     */
    public static int getRenderEnginTid() {
        return nativeGetRenderEnginTid();
    }

    /**
     * @hide
     */
    public static int[] getHwcTids() {
        return nativeGetHwcTids();
    }
    //SPD:add for sf thread info by sifeng.tian 20231117 end
}
